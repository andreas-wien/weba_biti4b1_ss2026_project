...
NGINX_CONF="/etc/nginx/sites-available/static.148.211.62.46.clients.your-server.de_project"
NGINX_ENABLED="/etc/nginx/sites-enabled/static.148.211.62.46.clients.your-server.de_project"
...
sudo cp ../nginx/myproject.conf $NGINX_CONF
